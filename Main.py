...
IsPi = input("IsPi (T,F): ").lower() == "t" and True or False
TakeShots  = input("Save Camera Shots (T,F): ").lower() == "t" and True or False
LoadSounds = input("Load Sounds (T,F): ").lower() == "t" and True or False
...
Websitefiles = listdir(rpath+"templates")#LoadDir(rpath+"templates",True)
